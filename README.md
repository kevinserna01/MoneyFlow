...
- [API Integration Guide](API_INTEGRATION.md) - Guía detallada de integración con la API
...
4. **ProGuard**: Habilita ProGuard/R8 en release para ofuscar el código
...
Desarrollado como parte del proyecto MoneyFlow.
